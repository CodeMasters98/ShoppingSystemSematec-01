...
using ShoppingSystemSematec.Domain.Settings;
using ShoppingSystemSematec.Infrastructure.Identity.Context;
using ShoppingSystemSematec.Infrastructure.Identity.Entities;
using ShoppingSystemSematec.Infrastructure.Identity.Repositories;
using System.Text;

namespace ShoppingSystemSematec.Infrastructure.Identity;
...
public static class ConfigureService
{
    public static IServiceCollection RegisterIdentityInfrastructureServices(this IServiceCollection services,IConfiguration configuration, string connectionString)
    {
        ...
        services.AddTransient<ShoppingSystemSematec.Application.Contracts.IAuthenticationService, AuthenticationService>();
